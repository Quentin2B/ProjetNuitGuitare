            ...
            <div class="col-lg-12 mb-4">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">derniers courses </h6>
                </div>
                <div class="card-body">
                  <h4 class="small font-weight-bold">cours 1 <span class="float-right">include information rather than a bar</span></h4>
